...
const emCards: Card[] = [
  ...
  c("em-demag", "退磁分析", [
    ...
    { key: "tmax_nonlinear", label: "非线性退磁实验", type: "yesno", value: false, showIfAny: ["tmax"] },
    { key: "pmax", label: "最大输出工况", type: "checkbox", value: true },
    { key: "pmax_nonlinear", label: "非线性退磁实验", type: "yesno", value: false, showIfAny: ["pmax"] },
    { key: "scmax", label: "短路最大电流工况", type: "checkbox", value: true },
    { key: "scmax_nonlinear", label: "非线性退磁实验", type: "yesno", value: false, showIfAny: ["scmax"] },
